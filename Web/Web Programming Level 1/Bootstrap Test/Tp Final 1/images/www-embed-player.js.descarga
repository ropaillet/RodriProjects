...
;var If=0,Jf=r("ytDomDomGetNextId")||function(){return++If};
q("ytDomDomGetNextId",Jf,void 0);function Kf(a,b,c){bf.call(this,a,b,c||M("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.l=this.b=this.j=null}
aa(Kf,bf);var Lf={log_event:"events",log_interaction:"interactions"},Mf={},Nf={},Of=0,G=r("ytLoggingTransportLogPayloadsQueue_")||{};q("ytLoggingTransportLogPayloadsQueue_",G,void 0);var Pf=r("ytLoggingTransportTokensToCttTargetIds_")||{};q("ytLoggingTransportTokensToCttTargetIds_",Pf,void 0);
...
;function ih(){if(null==r("_lact",window)){var a=parseInt(M("LACT"),10),a=isFinite(a)?y()-Math.max(a,0):-1;q("_lact",a,window);q("_fact",a,window);-1==a&&jh();xg(document,"keydown",jh);xg(document,"keyup",jh);xg(document,"mousedown",jh);xg(document,"mouseup",jh);Af("page-mouse",jh);Af("page-scroll",jh);Af("page-resize",jh)}}
function jh(){null==r("_lact",window)&&(ih(),r("_lact",window));var a=y();q("_lact",a,window);-1==r("_fact",window)&&q("_fact",a,window);zf("USER_ACTIVE")}
...
;var Dh=r("ytLoggingLatencyUsageStats_")||{};q("ytLoggingLatencyUsageStats_",Dh,void 0);var Eh=0;function Fh(a){Dh[a]=Dh[a]||{count:0};var b=Dh[a];b.count++;b.time=lb();Eh||(Eh=ce(Gh,0));return 10<b.count?(11==b.count&&Tg(Error("CSI data exceeded logging limit with key: "+a)),!0):!1}
